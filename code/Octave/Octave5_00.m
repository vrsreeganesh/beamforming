...
%% Loading the files
angleaxis		= csvread("../csv-files/angleaxis-Objective-5.csv");
anglegains		= csvread("../csv-files/anglematrix-Objective-5.csv");
...
saveas(gcf, "../Figures/anglegainsindB-Objective5.png");